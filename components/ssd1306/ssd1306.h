...
/**
 * @brief  Initializes I2C descriptor
 * @param  sda_gpio: I2C SDA Pin number
 * @param  scl_gpio: I2C SCL Pin number
 * @param  port: I2C port number
 * @retval Initialization status:
 *           - ESP_FAIL: I2C descroptor initialized fail
 *           - ESP_OK: I2C descroptor initialized sucess
 */
 ...
 * @param  None
 * @retval Initialization status:
 *           - ESP_FAIL: LCD was not detected on I2C port
 *           - ESP_OK: LCD initialized OK and ready to use
 */
